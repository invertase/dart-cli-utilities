...
extension AnsiStylesStringExtension on String {
  ...
  String get strip => AnsiStyles.strip(this);
  String rgb(num? r, num? g, num? b) => AnsiStyles.rgb(r, g, b).call(this);
  String bgRgb(num? r, num? g, num? b) => AnsiStyles.bgRgb(r, g, b).call(this);
}
